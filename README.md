...
- [https://www.smolmachines.com/](): Same idea - hardware-isolated linux VMs - but it also
  works on Linux hosts via KVM. Has a cloud service ($10+/mo).

- [https://exe.dev/](): persistent cloud VMs, $20+/mo, includes LLM tokens. Seems to have
